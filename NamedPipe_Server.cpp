//This is the SERVER for the named pipe - find the client in a seperate file 
...
/* Server side
  ...
  Client side -----> this is in another project is VS
...
int main()
{
    ...
    //Write file params
    char szWriteFileBuffer[] = "Hello from named pipe server!";
    ...
    else
    {
        ...
        std::cout << "READING --->" << szReadFile << std::endl;
    }
